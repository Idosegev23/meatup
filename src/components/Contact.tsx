...
export default function Contact() {
  ...
  return (
    <>
      <section id="contact" className="bg-[#0D0D0D]" style={{ padding: '80px 0 100px 0' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '32px', marginBottom: '48px', textAlign: 'right' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '8px', backgroundColor: 'rgba(92,62,43,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#CD7F32', flexShrink: 0 }}>
              ...
              <div>
                ...
                <a href={config.phoneLink} style={{ color: '#F4F4F2', textDecoration: 'none' }}>
                  {config.phone}
                </a>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
              ...
              <div>
                ...
                <a href={config.whatsappLink} target="_blank" rel="noopener noreferrer" style={{ color: '#F4F4F2', textDecoration: 'none' }}>
                  WhatsApp
                </a>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
              ...
              <div>
                ...
                <a href={config.mapLink} target="_blank" rel="noopener noreferrer" style={{ color: '#F4F4F2', textDecoration: 'none' }}>
