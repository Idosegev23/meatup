      ...
      <div className="grid grid-cols-2 md:grid-cols-4" style={{ gap: '4px', padding: '0 4px' }}>
        {galleryImages.map((image, index) => (
          ...
          >
            ...
            {image.menuItemId && (
              <div className="absolute bottom-2 left-2 w-7 h-7 rounded-full bg-[#0a1628]/70 backdrop-blur-sm flex items-center justify-center">
          ...
          <>
            ...
            >
              ...
              >
                ...
                <button
                  onClick={() => setDishPopup(null)}
                  className="absolute top-6 left-6 z-10 w-10 h-10 rounded-full bg-[#0a1628]/60 backdrop-blur-sm flex items-center justify-center text-[#F2F1F0] hover:bg-[#BF9B7A] transition-colors"
                >
