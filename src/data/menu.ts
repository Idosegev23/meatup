...
export const menuData: MenuCategory[] = [
  // Row 1: Meatup Social | Meat your Burger
  {
    ...
    image: `${dishImg}/Beef-and-lamb-cigars.webp`,
    items: [
      {
        id: "frena-bread",
      ...
      },
      {
        ...
        price: 42,
        image: `${dishImg}/Eggplant-steak.webp`
      },
      {
        id: "meatup-wings",
        ...
        price: 42,
        image: `${dishImg}/Crispy-wings.webp`
      },
      {
        id: "crispy-nuggets",
        ...
        price: 42,
        image: `${dishImg}/Chicken-breast-nuggets.webp`
      },
      {
        id: "beef-cigar",
  ...
  },
  {
    ...
    image: `${dishImg}/Meat-up-burger.webp`,
    note: {
    ...
    items: [
      {
        ...
        price: 62,
        image: `${dishImg}/Crispy-chicken-burger.webp`
      },
      {
        id: "meatup-burger",
      ...
      },
      {
        ...
        price: 66,
        image: `${dishImg}/Midtown-burger.webp`
      },
      {
        id: "smash-and-eggs",
        name: { he: "סמאש אנד אגס", en: "Smash and Eggs" },
        description: { he: "סמאש בורגר 200 גר' - ביצת עין עם בצל ירוק, חסה לאליק ומלפפון כבוש", en: "Smash burger 200g - fried egg with green onion, lollo rosso lettuce and pickle" },
        price: 66,
        image: `${dishImg}/Double-smash-burger.webp`
      },
      {
        id: "topap-300",
        ...
        price: 82,
        image: `${dishImg}/Topup300-burger.webp`
      },
      {
        id: "beyond-burger",
      ...
      { id: "white-rice", name: { he: "אורז לבן", en: "White Rice" }, price: 17 },
      {
        ...
        price: 22,
        priceAlt: 44,
        image: `${dishImg}/French-fries.webp`
      },
      { id: "ranch-salad", name: { he: "סלט חסות ראנץ'", en: "Ranch Lettuce Salad" }, price: 22, image: `${dishImg}/Ranch-lettuce-salad.webp` },
      { id: "green-salad", name: { he: "סלט ירוק", en: "Green Salad" }, price: 22, image: `${dishImg}/Green-market-salad.webp` },
      { id: "potatoes", name: { he: "פוטטוס", en: "Potatoes" }, price: 24, image: `${dishImg}/Potatos.webp` },
      { id: "green-beans", name: { he: "שעועית ירוקה", en: "Green Beans" }, price: 24, image: `${dishImg}/Green-beans.webp` },
  ...
  // Row 2: סלטים | עיקריות
  {
    ...
    image: `${dishImg}/Grilled-chicken-thighs-and-avocado-salad.webp`,
    items: [
      {
        ...
        price: 52,
        image: `${dishImg}/Green-market-salad.webp`
      },
      {
      ...
      },
      {
        ...
        price: 66,
        image: `${dishImg}/Ribeye-kebab-salad.webp`
      },
      {
        id: "lettuce-salad",
  ...
  },
  {
    ...
    image: `${dishImg}/Ribeye-steak-antricot.webp`,
    items: [
      {
        id: "araisi-shuk",
      ...
      },
      {
        ...
        price: 62,
        image: `${dishImg}/Plancha-chicken-breast.webp`
      },
      {
        id: "entrecote-kebab",
        name: { he: "קבב אנטריקוט", en: "Entrecote Kebab" },
        description: { he: "שיפודי קבב עסיסיים (320 גר') עשויים מנתחי בקר מובחרים עם בצל ופטרוזיליה קצוצים, מוגשים עם תוספת לבחירה", en: "Juicy kebab skewers (320g) made from premium beef cuts with chopped onion and parsley, served with choice of side" },
        price: 72
      },
      {
        id: "chicken-thigh-marinade",
        name: { he: "פרגית במרינדה", en: "Marinated Chicken Thigh" },
        description: { he: "סטייק פרגית במרינדה פיקנטית, נצרב על הגריל ומוגש לצד תוספת לבחירה", en: "Chicken thigh steak in spicy marinade, seared on the grill, served with choice of side" },
        price: 74,
        image: `${dishImg}/Roasted-chicken-leg.webp`
      },
      {
        id: "ribeye-select",
  ...
  // Row 3: קינוחים | אלכוהול
  {
    ...
    image: `${dishImg}/Warm-chocolate-fondant.webp`,
    items: [
      {
        id: "kinder-cookies",
        ...
        price: 42,
        image: `${dishImg}/Cookies-kinder-cake.webp`
      },
      {
        id: "pistachio-tart",
        ...
        price: 42,
        image: `${dishImg}/Pistachio-lemon-tart.webp`
      },
      {
        id: "sorbet-fruits",
      ...
      },
      {
        ...
        price: 46,
        image: `${dishImg}/Vanilla-panna-cotta-and-berries.webp`
      },
      {
        id: "fondant",
  ...
  // Row 4: ילדים | שתיה קלה
  {
    ...
    image: `${dishImg}/Junior-burger.webp`,
    note: {
    ...
    items: [
      { id: "kids-burger", name: { he: "בורגר 150 גר'", en: "Burger 150g" }, price: 58, image: `${dishImg}/Junior-burger.webp` },
      { id: "kids-schnitzel", name: { he: "שניצלונים", en: "Schnitzel Bites" }, price: 58, image: `${dishImg}/Chicken-breast-schnitzel-bites.webp` },
      { id: "kids-chicken-breast", name: { he: "חזה עוף", en: "Chicken Breast" }, price: 58, image: `${dishImg}/Plancha-chicken-breast.webp` },
      { id: "kids-chicken-thigh", name: { he: "פרגית צלויה", en: "Grilled Chicken Thigh" }, price: 58, image: `${dishImg}/Junior-chicken-thigh-steak.webp` }
    ]
  },
  {
    id: "soft-drinks",
    ...
    image: "/imgs/dishes/bevreges.webp",
    items: [
      // משקאות קלים
