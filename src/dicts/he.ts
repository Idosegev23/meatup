export const he = {
  ...
  about: {
    ...
    text2: "הצלייה שלנו נעשית בטמפרטורה מדויקת ובתזמון מושלם - כי אנחנו יודעים שההבדל בין סטייק טוב לסטייק מושלם נמצא בפרטים הקטנים. כל מנה מוגשת בעיצוב מוקפד, בסביבה נעימה ומזמינה.",
